...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Minh Sơn - Trường TH Vĩnh Hảo - ĐT: 0918 060 623</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Minh Sơn - Trường TH Vĩnh Hảo - ĐT: 0918 060 623</div>", unsafe_allow_html=True)
